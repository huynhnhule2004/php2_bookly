                ...
                <div id="wrapper" class="wp-inner clearfix">
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="/cart" class="btn btn-primary text-white" style="padding: 0.5rem 1.5rem;">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <td colspan="7">
                                                <div class="clearfix">
                                                    <div class="fl-right">
                                                        <a href="/checkout" title="" style="float: right;" class="btn btn-danger text-white">Thêm tất cả vào giỏ</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                    ...
                    <div class="section" id="action-cart-wp">
                        <div class="section-detail">
                            ...
                            <a href="/cart/deleteAll" title="" id="delete-cart">Xóa tất cả</a>
                        </div>
                    </div>
                <?php
                        else :
