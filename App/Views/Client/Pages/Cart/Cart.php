                        ...
                        ?>
                            <div class="section-detail table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php
                                        foreach ($data['list_buy']['buy'] as $item) :
                                        ?>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <!-- <button class="btn-quantity update-cart-btn" data-id="<?= $item['id'] ?>" data-action="decrease">-</button> -->
                                                        <input type="text" value="<?= $item['qty'] ?>" class="form-control text-center mx-2 quantity-input" style="width: 60px; height: 40px;" readonly>
                                                        <!-- <button class="btn-quantity update-cart-btn" data-id="<?= $item['id'] ?>" data-action="increase">+</button> -->
                                                    </div>
                                        ...
                                        <tr>
                                            <td colspan="7">
                                                <div class="clearfix">
                                                    ...
                                                    ?>
                                                    <p id="total-price" class="fl-right" style="float: right;">Tổng giá: <span class="text-danger"><?= isset($data['list_buy']['info']['total']) ? number_format($data['list_buy']['info']['total']) : '0'; ?> đ</span> </p>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
