            ...
            <header id="header" class="site-header">
                ...
                <div class="top-info border-bottom d-none d-md-block ">
                    <div class="container-fluid">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <p class="fs-6 my-2 text-center">Cần hỗ trợ? Gọi ngay cho chúng tôi qua số <a href="tel:0364402449" class="text-decoration-underline">0364402449</a></p>
                            </div>
                        ...
                        <div class="offcanvas offcanvas-end" tabindex="-1" id="bdNavbar" aria-labelledby="bdNavbarOffcanvasLabel">
                            ...
                            <div class="offcanvas-body">
                                <ul id="navbar"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link me-4 <?= ($_SERVER['REQUEST_URI'] == '/' ? 'active' : '') ?>" href="/">Trang chủ</a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link me-4 <?= ($_SERVER['REQUEST_URI'] == '/blogs' ? 'active' : '') ?>" href="/blogs">Bài viết</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link me-4 <?= ($_SERVER['REQUEST_URI'] == '/about' ? 'active' : '') ?>" href="/about">Giới thiệu</a>
                                    </li>

                                    <li class="nav-item">
                                        <a class="nav-link me-4 <?= ($_SERVER['REQUEST_URI'] == '/contact' ? 'active' : '') ?>" href="/contact">Liên hệ</a>
                                    </li>
                                </ul>
                                        ...
                                        <li class="wishlist-dropdown dropdown pe-3">
                                            ...
                                            <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                                                ...
                                                <div class="d-flex flex-wrap justify-content-center">
                                                    <a href="/cart" class="w-100 btn btn-dark mb-1" type="submit">Thêm tất cả vào giỏ</a>
                                                    <a href="/cart" class="w-100 btn btn-primary" type="submit">Xem giỏ hàng</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="cart-dropdown dropdown">
                                            ...
                                            <div class="dropdown-menu animate slide dropdown-menu-start dropdown-menu-lg-end p-3">
                                                ...
                                                <div class="d-flex flex-wrap justify-content-center">
                                                    ...
                                                    <a href="/cart" class="w-100 btn btn-primary" type="submit">Thanh toán</a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
